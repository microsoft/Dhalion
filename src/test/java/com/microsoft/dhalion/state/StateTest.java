...
public class StateTest {
  ...
  public void testSnapshotConstruction() {
    ...
    assertEquals(2, snapshot.getState().size());
  ...
  public void testSnapshotConstructionWithStats() {
    ...
    stats.put("c1", new MetricsStats(100,100,100));
    stats.put("c2", new MetricsStats(200,200,200));

    State snapshot = new State();
    snapshot.initialize();
    snapshot.addToState(metrics, stats, "m1");
    ...
    stats2.put("c1", new MetricsStats(300, 300, 300));
    stats2.put("c2", new MetricsStats(400, 400, 400));

    snapshot.addToState(metrics2, stats2, "m2");
